...
<head>
  ...
  <form class="form-horizontal" action='signup.php' method='POST'>
    ...
    <div class="controls">
      <input type="text" name='first_name' id="first_name" placeholder="Ex: Shahadat">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="last_name">Last Name</label>
    <div class="controls">
      <input type="text" name='last_name' id="last_name" placeholder="Ex: Mahamud">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="user_name">User Name</label>
    <div class="controls">
      <input type="text" name='user_name' id="user_name" placeholder="Ex: bithilcste">
    </div>
  </div>
   <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="email" name='email' id="email" placeholder="Ex: bithilnstu@gmail.com">
    </div>
  </div>
  <div class="control-group">
